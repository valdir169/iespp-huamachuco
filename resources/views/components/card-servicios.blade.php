        ...
        <div class="p-3 grid gap-4 sm25pxd-cols-2 sm:gap-10 md:grid-cols-3">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <span class="pt-8 flex items-center gap-2"><i
                            class='bx bx-current-location text-[25px]'></i>{{ $direccion }}</span>
                    <span class=" flex items-center gap-2"><i
                            class='bx bxs-phone-call text-[25px]'></i>{{ $telefono }}</span>
                    <span class=" flex items-center gap-2"><i
                            class='bx bxs-envelope text-[25px]'></i>{{ $email }}</span>
                </div>
            </div>
            <div class="flex flex-col gap-8">
                ...
                <ul class="flex justify-center gap-2 lg:flex-col ">
                    <li>
                        <a href="https://www.facebook.com/iesppjfsanchezcarrion" target="_blank"
                            class="flex items-center gap-2">
                            <i class='bx bxl-facebook-circle text-[25px] text-[#3477db]'></i> <span
                                class="hidden lg:block">Facebook</span></a>
                    </li>
                    <li>
                        <a href="https://www.youtube.com/@iesppjosefaustinosanchezca9494" target="_blank"
                            class="flex items-center gap-2">
                            <i class='bx bxl-youtube text-[25px] text-[#ff4c4c]'></i>
