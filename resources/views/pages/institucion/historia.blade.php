...
@section('content')
    ...
    <article class="render py-12">
        ...
        <p>El 28 de abril de 1981 mediante la Resolución Ministerial 432 del año 1981 se reapertura Escuela Normal Mixta
            ...
            019 del año 1985 se adecua a Instituto Superior Pedagógico. Actualmente tiene la denominación: Instituto de
            Educación Superior Pedagógico Público José Faustino
            Sánchez Carrión. <br> Ha formado más de 3000 maestros en diferentes especialidades. Más del 80% de maestros de
            la
            región La Libertad son egresados de ésta “Alma Mater”. <br><br>
            Es una institución ganadora en experiencias exitosas con el proyecto “Centros Pilotos Rurales 2005” que fue
            validado
            en la Universidad de Temuco, Chile. Promotora del rescate de diferentes danzas de nuestras comunidades, tales
            ...
            Con el funcionamiento de su Centro de Aplicación obtuvo grandes logros y sus egresados son profesionales de
            éxito.

            En el año 2016 obtuvo la Acreditación Institucional como Institución de Nivel superior que brinda una educación
            de
            calidad.

            Actualmente vienen formando profesionalmente 486 estudiantes en los Programas de estudios: Educación Secundaria
            en
            la especialidad de Comunicación, Idiomas en la
            especialidad de Inglés y Educación Inicial. Vienen formándose 476 estudiantes
    </article>
@endsection
