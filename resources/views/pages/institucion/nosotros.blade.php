...
@section('content')
    ...
    <article class="bg-[#ebebeb] h-auto render py-24 grid md:grid-cols-2 gap-12 lg:gap-32">
    ...
    <div class="render  py-24  box-border">
        <h4 class="title py-4">Nuestros valores</h4>
        <div class="flex  justify-center flex-wrap gap-8 xl:gap-16 py-4">
            <div
                class="border border-[#3477DB] rounded-lg text-center p-2 flex flex-col justify-between hover:bg-[#ebebeb] transition cursor-pointer">
