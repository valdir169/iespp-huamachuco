        ...
        <section class="grid md:grid-cols-2 gap-4 lg:gap-8 xl:gap-12 2xl:gap-20">
            ...
            <div class="h-full">
                <p>
                    ...
                    para adaptarse a las nuevas realidades, resolver problemas y generar ideas innovadoras.</br></br>
                    Nuevamente estamos en la etapa académica más importante del pedagógico de Huamachuco, desde la Dirección
                    del
                    ...
                    Las necesidades educativas del país, requieren de profesionales altamente comprometidos con la
                    educación, nuestra misión
                    y responsabilidad es que ustedes lo sean. <br><br>
