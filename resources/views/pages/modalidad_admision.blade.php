                        ...
                        <ul class="nav nav-tabs grid grid-cols-2 min-[400px]:grid-cols-3">
                            ...
                            <li class="h-[120px] lg:h-[150px]">
                                <a class="h-full" href="#tab2">
                                    <p class="flex justify-center items-center flex-col"><i
                                            class='bx bx-hive text-[2rem] lg:text-[3rem]'></i><span
                                            class="text-xs text-center lg:text-sm">Idiomas, Especialidad: Ingles</span></p>
                                </a>
                            </li>
                            <li class="h-[120px] lg:h-[150px]">
                                <a class="h-full" href="#tab3">
                                    <p class="flex justify-center items-center flex-col"><i
                                            class='bx bx-user-voice text-[2rem] lg:text-[3rem]'></i><span
                                            class="text-xs text-center lg:text-sm">Educación Secundaria, Especialidad:
                                            Comunicación</span></p>
                                </a>
                            </li>
                        </ul>
                            ...
                            <div class="flex justify-center items-center gap-16 flex-col lg:gap-36">
                                <div class="flex gap-20 w-full flex-col">
                                    <div class="grid gap-2">
                                        <span
                                            class="font-black border-b border-[#3477db] py-1 w-full sm:w-2/5 lg:w-3/5 xl:w-1/2 subtitle">Modalidad
                                            por Exoneración</span>
                                    ...
                                    <div class="grid gap-4 sm:flex items-center justify-between"">
                                        <div>
                                            <ul class="pl-5 lg:pl-10 2xl:pl-24">
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Primeros
                                                        y segundos puestos de las instituciones educativas de Educación
                                                        básica (4 vacantes ).</span></li>
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Egresados
                                                        del COAR (1 vacante).</span></li>
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Deportistas
                                                        Calificados “Representación nacional” (1 vacante).</span></li>
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Estudiantes
                                                        Con discapacidad (1 vacante).</span></li>
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Soldados
                                                        del ejercito peruano que se encuentran en servicio (1
                                                        vacante).</span></li>
                                            </ul>
                                        </div>
                                        <div>
                                ...
                                <div class="flex gap-20 w-full flex-col ">
                                    ...
                                    <div class="grid gap-4 sm:flex items-center justify-between">
                                        <div class="">
                                            <ul class="pl-5 lg:pl-10 2xl:pl-24">
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Primero
                                                        y segundo puesto de los exámenes sumatorios que se realizan en la
                                ...
                                <div class="flex gap-20 w-full flex-col">
                                    <div class="grid gap-2">
                                        <span
                                            class="font-black border-b border-[#3477db] py-1 w-full sm:w-2/5 lg:w-3/5 xl:w-1/2 subtitle">Modalidad
                                            Examen de Ordinario</span>
                                        <p>Esta dirigido a todos los las personas que culminaron la secundaria y los que se
                                            prepararon en la academia que brindo la institución.</p>
                                    </div>
                                    <div class="grid gap-4 sm:flex items-center justify-between">
                                        <div>
                                            <ul class="pl-5 lg:pl-10 2xl:pl-24">
                                                <li><span>Examen ordinario (Presencial en aulas de IESPP-Huamchuco):</span>
                                                    <ul class="pl-8 mt-2">
                                                        <li class="flex"><i
                                                                class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Evaluación
                                                                de competencias fundamentales (Ingreso Ordinario).</span>
                                                        </li>
                                                        <li class="flex"><i
                                                                class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Prueba
                                                                de competencias específicas y test de aptitud personal
                                                                vocacional (Ingreso Ordinario).</span></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="flex gap-20 sm:w-full flex-col ">
                                    ...
                                    <div class="grid gap-4 sm:flex items-center justify-between">
                                        <div class="">
                                            <ul class="pl-5 lg:pl-10 2xl:pl-24">
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Primer
                                                        puesto de los exámenes sumatorios que se realizan en la academia de
                                                        preparación del IESPP-JFSC Huamachuco.</span></li>
                                            </ul>
                                        </div>
                                        <div>
                                            <p
                                ...
                                <div class="flex gap-20 sm:w-full flex-col ">
                                    ...
                                    <div class="grid gap-4 sm:flex items-center justify-between">
                                        <div class="">
                                            <ul class="pl-5 lg:pl-10 2xl:pl-24">
                                                <li class="flex"><i
                                                        class='bx bx-check-square pr-2 sm:pr-3 text-[25px]'></i><span>Para
                                                        este programa de estudios de nivel superior, no se cuenta con
                                                        beneficio de examen ordinario.</span></li>
                                            </ul>
                                        </div>
                                        <div>
                                            <p
        ...
        <article class="render mb-5 md:mb-10">
            <div
                ...
                <p>Los postulantes que no ingresan al IESPP-JFSC Humachuco, a traves de cada modalidad que ofrecemos, tienen
                    una semana para recoger sus documentos, atte. Dirección.</p>
            </div>
        </article>
    </section>
    <section>
