...
@section('title', 'Educación Inicial - Iespp José Faustino Sánchez Carrión Huamachuco')

@section('content')
    <x-presentation>
        <x-slot name="img">{{ asset('images/programas/Pro-Inicial.jpg') }}</x-slot>
        ...
        <x-slot name="descripcion">Formar profesionales que contribuyan a mejorar los entornos en los que se desarrollen los
            niños y niñas en las primeras etapas de su educación, promoviendo un entorno de cuidado y estimulación
            adecuado.</x-slot>
                ...
                <div class="flex flex-col gap-6 lg:gap-8 sm:w-1/2">
                    ...
                    <div class="grid gap-2 lg:gap-6 pt-2 lg:pt-4">
                        ...
                        <ul>
                            ...
                            <li class="flex items-center pl-2">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Evalúa permanentemente el aprendizaje.</span>
                            </li>
                        </ul>
                    ...
                    <ul class="pt-2 lg:pt-4">
                        <li class="flex items-center">
                            ...
                            <span>Instituciones Educativas de Educación Inicial (Publicas y Privadas), como Profesional
                                Pedagógico en Educaci&oacute;n Inicial.</span>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <ul class="grid gap-2 lg:pt-4">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="lg:text-base">Recibo de pago por inscripción a la cta. banco de la nación:
                                <span class="font-black">080-100-3141</span> (Preguntar en Secretaria).
                            </span>
                        </li>
                        <li class="flex items-center">
                            <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Fundamentos de la Educación Inicial.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Interacciones de calidad y desarrollo en la Primera Infancia I.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Planificación por Competencias y Evaluación para el aprendizaje I.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Interacciones de calidad y desarrollo en la Primera Infancia II.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Inglés para Principiantes I / Beginner English I A1.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo personal y social en la primera infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Juego, Desarrollo y Aprendizaje en la Primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 1.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Inclusión Educativa para la Atención a la Diversidad.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Planificación por Competencias y Evaluación para el aprendizaje II.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 2.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Inglés para Principiantes III / Beginner English II A2.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo del Pensamiento.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo de la Psicomotricidad en la Primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo de la Comunicación en la Primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 3.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Alfabetización Científica .</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Inglés para Principiantes IV / Beginner English IV A2.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Convivencia y Ciudadanía en la Primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo de la Matemática en la primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Expresión del Arte en la primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 4.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Gestión de la Atención y Cuidado Infantil.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Desarrollo de la Creatividad en la Primera Infancia.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Aprendizaje y enseñanza de la Ciencia en ciclo II.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 5.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Políticas y Gestión para el Servicio Educativo.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Planificación por Competencias y Evaluación para el Aprendizaje III.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Atención a las Necesidades Educativas Especiales.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Curso Electivo 6.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Gestión de los Servicios Educativos en Educación Inicia.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Escuela, Familia y Comunidad.</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="grid gap-12 lg:gap-12">
            ...
            <div class="grid gap-12 sm:grid-cols-2 lg:gap-14">
                ...
                <div
                    ...
                    <div class="flex justify-center">
                        <div class="w-[60px] h-[60px] flex items-center justify-center rounded-full bg-[#2277db]">
                            <span class="text-white text-3xl">II</span>
                        </div>
                    </div>
