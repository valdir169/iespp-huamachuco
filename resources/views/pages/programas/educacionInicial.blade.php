        ...
        <article class="render py-20 sm:py-36">
            <div class="grid gap-3 lg:gap-12">
                ...
                <div class="grid gap-5 sm:grid-cols-2 lg:gap-14">
                    <div class="text-center grid gap-2 border rounded-3xl p-8 h-[350px] lg:h-[430px] cursor-pointer hover:-translate-y-6 hover:shadow-lg shadow-[#ebebeb] transition duration-300">
