            ...
            <div class="sm:flex justify-center">
                <div
                    ...
                    <a class="flex items-center justify-center gap-5 sm:flex-col sm:gap-3" href="#logros">
                        <i class='bx bx-line-chart text-[30px] sm:pb-1 2xl:text-[50px]'></i>Lo que lograrás
                    </a>
                </div>
                    ...
                    <ul class="pt-2 lg:pt-4">
                        <li class="flex items-center">
                            ...
                            <span>Instituciones Educativas de Educación Inicial (Publicas y Privadas), como Profesional
                                Pedagógico en Idiomas, Especialidad: Ingles.</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <article class="render">
            <div class="py-4 grid gap-2 sm:grid-cols-2 lg:py-10 lg:gap-6">
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Niñez y adolescencias: Desarrollo, Cambios e Identidades.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English II.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Niñez, adolescencias y aprendizajes.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Approaches and methods in language teaching.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English IV.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Linguistics for English Teachers.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English V.</span>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Literature perspectives I.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English VI.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Gestión de Aprendizajes para la Atención a la Diversidad.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Literature perspectives II.</span>
                            </li>
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English VIII.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>English, communities and cultures.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid gap-2 bg-[#3477db] p-4 rounded-[30px] h-[450px] xl:h-[400px]">
                    <div class="flex items-center justify-center gap-2 lg:gap-6">
                        <div class="w-[60px] h-[60px] flex items-center justify-center rounded-full bg-white">
                            <span class="font-bold text-black text-3xl">10</span>
                        </div>
                    ...
                    <div class="text-white">
                        <ul class="grid gap-2">
                            ...
                            <li class="flex items-center">
                                <i class='bx bx-check-circle pr-2 text-[25px]'></i>
                                <span>Políticas y Gestión Territorial
                                    del Servicio Educativo.</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="grid gap-12 lg:gap-12">
            <div class="flex flex-col justify-center items-center text-center gap-8">
                <span class="title flex flex-col sm:flex-row items-center">
                    ...
                    <span class="bg-[#ebebeb] text-[#3477db] ml-2 py-0.5 px-2"> Nuestra Familia</span>
                </span>
